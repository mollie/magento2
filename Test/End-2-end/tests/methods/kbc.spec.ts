...
const testCases = [
  {status: 'paid', orderStatus: 'Processing', title: '[C3080] Validate the submission of an order with KBC/CBC as payment method and payment mark as "Paid"'},
  {status: 'failed', orderStatus: 'Canceled', title: '[C3077] Validate the submission of an order with KBC/CBC as payment method and payment mark as "Failed"'},
  {status: 'expired', orderStatus: 'Canceled', title: '[C3079] Validate the submission of an order with KBC/CBC as payment method and payment mark as "Expired"'},
  {status: 'canceled', orderStatus: 'Canceled', title: '[C3078] Validate the submission of an order with KBC/CBC as payment method and payment mark as "Cancelled"'},
];
